...
import {withTooltip, Tooltip, useTooltip} from '@visx/tooltip';
...
export const ScatterPlotChart = withTooltip<DotsProps, PointsRange>(
    ({
         width,
         height,
         showControls = true,
        ...
        const { tooltipData, tooltipLeft, tooltipTop, tooltipOpen, showTooltip, hideTooltip } = useTooltip<PointsRange>();
        ...
        const handleMouseMove = useCallback(
            (event: React.MouseEvent | React.TouchEvent, d) => {
                ...
                const closestData: PointsRange = closest.data as PointsRange
                if (closest) {
                    showTooltip({
                        tooltipLeft: xScale(x(closestData)),
                        tooltipTop: yScale(y(closestData)),
